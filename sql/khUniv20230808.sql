...
--
--CREATE VIEW CMEMBER AS SELECT NOTICE_NO, COMMENT_NO, MEMBER_NO, MEMBER_NAME, COMMENT_CONTENT, CWRITTEN_TIME FROM MEMBER M JOIN "COMMENT" C ON (M.MEMBER_NO = C.COMMENTER)
--ORDER BY NOTICE_NO;
--
--INSERT INTO "COMMENT" VALUES (2, SYSDATE, 2, 'P082', '안녕하세요2');
--INSERT INTO "COMMENT" VALUES (3, SYSDATE, 2, 'A473023', '안녕하세요3');
--
--SELECT MEMBER_NAME, COMMENT_CONTENT, CWRITTEN_TIME FROM CMEMBER WHERE NOTICE_NO= 2;
--UPDATE NOTICE SET NOTICE_TITLE = '안녕하세요', NOTICE_CONTENT= '반갑습니다' WHERE NOTICE_NO = 16; 
--
--DELETE FROM NOTICE WHERE NOTICE_NO = 16;
--DELETE FROM NOTICE WHERE NOTICE_NO = 2;
--commit;
--
--DELETE FROM "COMMENT" WHERE NOTICE_NO = 24;
--DELETE FROM NOTICE WHERE NOTICE_NO = 24;
--
--DELETE FROM TB1(SELECT * FROM "COMMENT" C JOIN NOTICE N ON N.NOTICE_NO=C.NOTICE_NO) TB1 WHERE NOTICE_NO = 25;
--
--DELETE FROM "NOTICE" WHERE NOTICE_NO IN (SELECT N.NOTICE_NO FROM "COMMENT" C JOIN NOTICE N ON N.NOTICE_NO = C.NOTICE_NO WHERE N.NOTICE_NO = 22);
--COMMIT;