    ...
    <body>
        ...
        <table class="noticeFill">
            <tr>
                ...
                <td class="ntitle"><input type="title" size="30" name="ntitle" placeholder="제목을 입력하시오." required></td>
            </tr>
            <tr>
            <td>
                <br>
            ...
            <tr>
                ...
                <td class="ncontent"><textarea name="ncontent" cols="50" rows="10" placeholder="내용을 입력하시오." required></textarea></td>
            </tr>
            <!-- <tr>
            ...
            <tr>
                ...
                <td colspan="2" class="nsubmit"><button type="submit">제출하기</button></td>
